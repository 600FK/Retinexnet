...
parser.add_argument('--save_dir', dest='save_dir', default='./data/test_results', help='directory for testing outputs')
...
def lowlight_train(lowlight_enhance):
    ...
    train_low_data_names = glob('./data/demist/hazy/*.png') #+ glob('./data/demist/hazy/*.png')
    train_low_data_names.sort()
    train_high_data_names = glob('./data/demist/gt/*.png') #+ glob('./data/demist/gt/*.png')
    ...
    for idx in range(len(train_low_data_names)):
        ...
        # print(np.array(low_im).shape)
        train_low_data.append(low_im)
        high_im = load_images(train_high_data_names[idx])
        print(np.array(high_im).shape)
